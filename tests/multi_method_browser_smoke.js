...
const csv=[
  ...
  '24,28,42100,A','25,35,46800,B','26,39,49700,A','27,47,54800,B',
  '28,56,60300,A','29,63,65900,B','30,75,73100,A','31,82,79200,B',
  '32,95,87900,A','33,103,94100,B','34,118,103500,A','35,127,111200,B'
].join('\n');
